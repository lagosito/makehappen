		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					...
					<span class="description"><?php printf( wp_kses_post( __( 'Leave empty to use <a href="%s" target="_blank">global settings</a>.', 'snax' ) ), esc_url( admin_url( snax_admin()->settings_page . '?page=snax-voting-settings' ) ) ); ?></span>
				</td>
			</tr>
			</tbody>
		</table>
