  ...
  $.FE.PLUGINS.video = function (editor) {
    ...
    function insertByURL (link) {
      ...
      var xhr = $.ajax({
          ...
          'data': {
              ...
              'snax_embed_type':  'url',
              'snax_embed_code':  link
          }
      });

      xhr.done(function (res) {
          if (res.status === 'success') {
              insert(res.args.html);
          } else {
              editor.events.trigger('video.linkError', [link, res.message]);
          }
      });
    ...
    function insertEmbed (code) {
        ...
        var xhr = $.ajax({
            ...
            'data': {
                'action':           'snax_load_content_embed_tpl',
                'snax_embed_type':  'code',
                'snax_embed_code':  code
            }
        });
        ...
        xhr.done(function (res) {
            if (res.status === 'success') {
                ...
                editor.events.trigger('video.codeError', [code, res.message]);
            }
        });
    }
