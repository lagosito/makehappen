...
<?php
$snax_has_images = snax_has_user_cards( 'gallery' );
...
<?php do_action( 'snax_before_frontend_submission_form', 'gallery' ); ?>

	<form action="" method="post" class="<?php echo implode( ' ', array_map( 'sanitize_html_class', $snax_class ) ); ?>">
		<?php do_action( 'snax_frontend_submission_form_start', 'gallery' ); ?>
		...
		<div class="snax-form-main">
			...
			<div class="snax-cards">
				<?php
				if ( snax_has_user_cards( 'gallery' ) ) :
		...
		<?php do_action( 'snax_frontend_submission_form_end', 'gallery' ); ?>
	</form>

<?php do_action( 'snax_after_frontend_submission_form', 'gallery' ); ?>
