...
<div id="quizzard" class="quizzard-quiz">
	...
	<p class="nav-tab-wrapper quizzard-tab-wrapper">
		<a href="" class="nav-tab<?php echo 0 === $snax_tab_index ? ' nav-tab-active' : ''; ?>"><?php esc_html_e( 'Personalities', 'snax' ); ?></a>
		<a href="" class="nav-tab<?php echo 1 === $snax_tab_index ? ' nav-tab-active' : ''; ?>"><?php echo esc_html_e( 'Questions', 'snax' ); ?></a>
	...
	<div class="quizzard-results quizzard-tab-content<?php echo 0 === $snax_tab_index ? ' quizzard-tab-content-active' : ''; ?>" id="quizzard-results">

		<div class="quizzard-results-header">
			<h2><?php esc_html_e( 'Personalities', 'snax' );?></h2>
		</div>

		<ul class="quizzard-r-items" id="quizzard-r-items">
			<li class="quizzard-r-item quizzard-next-r-item">
				<?php snax_get_template_part( 'quizzes/personality/form/result-next-tpl' ); ?>
			</li>
		</ul><!-- .quizzards-r-items -->

	</div>

	<div class="quizzard-questions quizzard-tab-content<?php echo 1 === $snax_tab_index ? ' quizzard-tab-content-active' : ''; ?>">
		...
		<ul class="quizzard-q-items" id="quizzard-q-items">
			<li class="quizzard-q-item quizzard-next-q-item">
				<?php snax_get_template_part( 'quizzes/personality/form/question-next-tpl' ); ?>
			</li>
	...
	<div class="quizzard-settings quizzard-tab-content<?php echo 2 === $snax_tab_index ? ' quizzard-tab-content-active' : ''; ?>">
		<?php snax_get_template_part( 'quizzes/personality/form/settings' ); ?>
	</div>
	<?php endif; ?>
...
<input type="hidden" name="snax_quiz" value="personality" />

<script type="text/template" id="quizzard-question-tpl">
	<?php snax_get_template_part( 'quizzes/personality/form/question-tpl' ); ?>
</script>

<script type="text/template" id="quizzard-answer-tpl">
	<?php snax_get_template_part( 'quizzes/personality/form/answer-tpl' ); ?>
</script>

<script type="text/template" id="quizzard-result-tpl">
	<?php snax_get_template_part( 'quizzes/personality/form/result-tpl' ); ?>
</script>
...
<script>
	(function (ctx) {
		...
		ctx.snax_quizzes.quiz = {
			...
			type: 		'<?php echo esc_html( snax_get_personality_quiz_type() ); ?>',
