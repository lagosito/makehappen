...
<div class="quizzard-answer">
	<div class="quizzard-answer-header">
		<a class="quizzard-icon quizzard-icon-delete quizzard-answer-delete" href="#"><?php esc_html_e( 'Delete', 'snax' ); ?></a>
	</div>
	...
	<div class="quizzard-answer-body">
		...
		<label class="quizzard-answer-correct-label" title="<?php esc_attr_e( 'Is this answer correct?', 'snax' ); ?>">
			<?php esc_html_e( '+1 for ', 'snax' ); ?>
			<select name="snax_answer_correct_<%- question_id %>" class="quizzard-answer-correct"></select>
		</label>
	</div>
</div>
