...
$snax_reveal_correct_wrong_answers 	= snax_get_quiz_setting( 'reveal_correct_wrong_answers' );
...
<table class="form-table">
	<tbody>
		...
		<tr>
			<th>
				<label for="snax_reveal_correct_wrong_answers">
					<?php esc_html_e( 'Reveal correct/wrong answers', 'snax' ); ?>
				</label>
			</th>
			<td>
				<select id="snax_reveal_correct_wrong_answers" name="snax_reveal_correct_wrong_answers">
					...
					<option value="quiz-end"<?php selected( $snax_reveal_correct_wrong_answers, 'quiz-end' ); ?>><?php esc_html_e( 'at the end of the quiz', 'snax' ); ?></option>
				</select>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input id="snax_questions_per_quiz" name="snax_questions_per_quiz" value="<?php echo esc_attr( $snax_questions_per_quiz ); ?>" placeholder="<?php esc_attr_e( 'Leave empty to show all available questions', 'snax' ); ?>" />
				<span><?php esc_html_e( 'works only with "Shuffle questions" options enabled', 'snax' ); ?></span>
			</td>
		</tr>
