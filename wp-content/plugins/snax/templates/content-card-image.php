...
<div class="snax-card snax-card-image snax-card-blur" data-snax-id="<?php the_ID(); ?>">
	...
	<div class="snax-card-body">
		...
		<p class="snax-card-source">
			...
			<input id="snax-card-<?php the_ID(); ?>-has-source" name="" type="checkbox"<?php checked( ! empty( $snax_card_source ) ); ?> /> <label for="snax-card-<?php the_ID(); ?>-has-source"><?php esc_html_e( 'Not your original work? Note the source', 'snax' ); ?></label>
