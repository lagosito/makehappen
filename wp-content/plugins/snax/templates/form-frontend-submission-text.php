...
$snax_class = array(
	...
	'snax-form-frontend-format-text',
);
...
<?php do_action( 'snax_before_frontend_submission_form', 'text' ); ?>

	<form action="" method="post" class="<?php echo implode( ' ', array_map( 'sanitize_html_class', $snax_class ) ); ?>">
		<?php do_action( 'snax_frontend_submission_form_start', 'text' ); ?>
		...
		<div class="snax-form-main">
			...
			<?php snax_get_template_part( 'posts/form-edit/row-content' ); ?>
		...
		<div class="snax-form-side">
			...
			<input type="hidden" name="snax-post-format" value="text"/>

			<?php
			global $snax_post_format;
			$snax_post_format = 'text';
		...
		<?php do_action( 'snax_frontend_submission_form_end', 'text' ); ?>
	</form>

<?php do_action( 'snax_after_frontend_submission_form', 'text' ); ?>
