...
jQuery.ajax({
          ...
          success: function(data) {
                ...
                document.getElementById('Advimp_pieStats').innerHTML = "<h2 style='color: red;text-align: center;padding-top: 100px;' >No Imports Yet</h2>";
                return false;
                }
                Morris.Donut({
                        element: 'Advimp_pieStats',
                        data: val//[
...
jQuery.ajax({
          ...
          success: function(result) {
                ...
                var months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
                 Morris.Line({
                        element: 'Advimp_lineStats',
                        data   : val,
                        xkey: 'year',
                        ykeys: ['post', 'page','custompost','users'],
                        labels: ['post', 'page','custompost','users'],
                        lineColors:['gray','red','blue','orange'],
