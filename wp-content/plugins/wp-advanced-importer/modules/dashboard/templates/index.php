...
<div class="box-one">
	<div class="top-right-box">
		<h3><span style="margin: -5px 5px 5px 5px;"><img src="<?php echo esc_url(WP_CONST_ADVANCED_XML_IMP_DIR."images/chart_bar.png");?>" /></span><?php echo esc_html__('Importers Activity','wp-advanced-importer'); ?></h3>
	...
	<div class="top-right-box">
		<h3><span style="margin: -5px 5px 5px 5px;"><img src="<?php echo esc_url(WP_CONST_ADVANCED_XML_IMP_DIR."images/stat_icon.png");?>" ></span><?php echo esc_html__('Import Statistics','wp-advanced-importer'); ?></h3>
		<div class="top-right-content">
			<div id='dispLabel'></div>
