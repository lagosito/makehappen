...
?>
<script src= "<?php echo WP_CONTENT_URL; ?>/plugins/<?php echo WP_CONST_ADVANCED_XML_IMP_SLUG;?>/js/jquery.js" type="text/javascript"></script>
<script src= "<?php echo WP_CONTENT_URL; ?>/plugins/<?php echo WP_CONST_ADVANCED_XML_IMP_SLUG;?>/js/jquery.sparkline.js" type="text/javascript"></script>
<script src="<?php echo WP_CONTENT_URL; ?>/plugins/<?php echo WP_CONST_ADVANCED_XML_IMP_SLUG;?>/js/jquery.flot.min.js" type="text/javascript"></script>
<script>
    var inserted = skipped = updated = [];
</script>
<?php
global $wpdb;
$getDetails = $wpdb->get_results($wpdb->prepare("select * from smackcsv_status_log where sdm_id = %s",$_REQUEST['sdmid']));
