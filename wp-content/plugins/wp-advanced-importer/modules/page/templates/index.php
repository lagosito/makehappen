...
?>
	...
	<!-- The global progress bar -->
        <div class="form-group" style="padding-bottom:20px;">
                                ...
                                <input type='submit' name='importfile' id='importfile' title = '<?php echo __("Next",'wp-advanced-importer'); ?>' value='<?php echo $impCE->reduceStringLength(__("Next",'wp-advanced-importer'),'Next'); echo __(" >>");?>' disabled
	...
	?>
	<h3><?php echo esc_html__('Map XML to WP fields/attributes','wp-advanced-importer'); ?></h3>
...
?>
		...
		<input type='hidden' id='uploadedFile' name='uploadedFile' value='<?php echo sanitize_text_field($_POST['uploadedFile']); ?>' />
		...
		<div class="inside">
                   <label id="importalign"><input type ='radio' id='importNow' name='importMode' value='' onclick='choose_import_mode(this.id);' checked/> <?php echo esc_html__("Import right away",'wp-advanced-importer'); ?> </label>
                                        <label id="importalign"><input type ='radio' id='scheduleNow' name='importMode' value='' onclick='choose_import_mode(this.id);' disabled/> <?php echo esc_html__("Schedule now",'wp-advanced-importer'); ?> <img src="<?php echo esc_url(WP_CONST_ADVANCED_XML_IMP_DIR."images/pro_icon.gif");?>" title="PRO Feature" /></label>
...
<input type='hidden' name='wpnoncekey' id='wpnoncekey' value='<?php echo $nonce_Key; ?>' />
		<label id="importalign"><input name='duplicatetitle' id='duplicatetitle' type="checkbox" value="" > <?php echo esc_html__('Detect duplicate post title','wp-advanced-importer'); ?></label> <br>
		 <label id="importalign"><?php echo esc_html__('No. of posts per server request','wp-advanced-importer'); ?></label> <span class="mandatory" style="margin-left:-13px;margin-right:10px">*</span> <input name="importlimit" id="importlimit" type="text" value="1" placeholder="10" onblur="check_allnumeric(this.value);"></label> <?php echo $impCE->helpnotes(); ?> <br>
		...
		<input id="startbutton" class="btn btn-primary" type="button" value="<?php echo esc_attr__('Import Now','wp-advanced-importer'); ?>" onclick="importRecordsbySettings();" >
